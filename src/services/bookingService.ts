  ...
  class BookingService {
    ...
    async getUserBookings(userId: string | number): Promise<Booking[]> {
      try {
        ...
        try {
          const response = await fetch(`http://guiaogi.com/bookings?userId=${userId}`);
          if (response.ok) {
    ...
    async cancelBooking(bookingId: number, userId: string | number): Promise<void> {
      try {
        ...
        try {
          const getAllResponse = await fetch('http://guiaogi.com/bookings');
        ...
        try {
          ...
          if (response.ok) {
            ...
            try {
              ...
              try {
                const cancelledResponse = await fetch('http://guiaogi.com/cancelledBookings');
              ...
              if (!alreadyExists) {
                const addCancelledResponse = await fetch('http://guiaogi.com/cancelledBookings', {
                  method: 'POST',
                  headers: {
                    'Content-Type': 'application/json',
                  },
