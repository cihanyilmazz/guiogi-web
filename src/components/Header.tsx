...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="text-white py-2 sm:py-2.5 border-b" style={{ backgroundColor: '#9E0102' }}>
          ...
          <div className="hidden md:flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4 lg:space-x-6">
              ...
              >
                ...
                <span className="text-xs sm:text-sm lg:text-base">+90 555 123 45 67</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-xs sm:text-sm lg:text-base">info@guiaogi.com</span>
              </a>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 sm:justify-between">
              ...
              <div className="flex items-center flex-wrap justify-center gap-3 sm:gap-4">
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm truncate max-w-[180px] sm:max-w-none">info@guiaogi.com</span>
                </a>
              </div>
        ...
        <div className="flex justify-between items-center py-4 sm:py-5">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            >
              ...
              <span className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity" style={{ backgroundColor: 'rgba(158, 1, 2, 0.1)' }}></span>
            </Link>
            <Link 
              to="/turlar" 
              className="relative px-4 py-2 text-gray-700 font-medium rounded-lg transition-all duration-200 group"
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Button
                  ...
                  style={{ backgroundColor: '#9E0102', borderColor: '#9E0102' }}
                  onMouseEnter={(e) => {
